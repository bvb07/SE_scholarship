...
class Login_commitee extends Component {
  render() {
    return (
        ...
        <div className="area zone2">
            ...
            <div class="area2login">
              <div class="box2login">
                  ...
                  <div class="login lg1">
                    <label for="account">Account@ku.th(กรรมการ)</label>
                  </div>
                  <div class="login lg2">
              ...
              <div class="box2next">
                  ...
                  <Link to="/Login_admin">
                    <button class="cpage p3">
                      <img class="logo-kummakarn" src="https://icons.veryicon.com/png/o/miscellaneous/yuanql/icon-admin.png"></img>
